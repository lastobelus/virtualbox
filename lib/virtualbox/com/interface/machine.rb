  ...
  module COM
    module Interface
      class Machine < AbstractInterface
        ...
        function :get_cpu_property, T_BOOL, [T_UINT32]
        function :set_cpu_property, nil, [T_UINT32, T_BOOL]
        ...
        function :get_hw_virt_ex_property, T_BOOL, [T_UINT32, [:out, T_BOOL]]
        function :set_hw_virt_ex_property, T_BOOL, [T_UINT32, [:out, T_BOOL]]
        function :save_settings, nil, []
        function :discard_settings, nil, []
        function :delete_settings, nil, []
        function :export, :VirtualSystemDescription, [:IAppliance]
